...
const MapWithMarkers = ({ vessels, selectedVessel }) => {
  console.log('aqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq',vessels);
    ...
    if (map) {
      const updateMarkers = () => {
        ...
        if (markerClusterGroupRef.current) {
          ...
          // Adjust the cluster radius here
          markerClusterGroupRef.current = L.markerClusterGroup({
            maxClusterRadius: 30, // Adjust this value to change cluster size
          });
