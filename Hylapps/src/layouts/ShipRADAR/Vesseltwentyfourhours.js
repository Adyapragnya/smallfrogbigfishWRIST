...
const formatEntries = (opsData = [], trackedVessels = []) => {
  ...
  return opsData
    ...
    }).filter((vessel) => vessel.AisPullGfType === 'boundary');
    // .sort(sortPriority); // Apply sorting based on GeofenceType
};



const Vesseltwentyfourhours = ({ vessels = [], onRowClick }) => {
...
Vesseltwentyfourhours.propTypes = {
  vessels: PropTypes.array.isRequired,
  onRowClick: PropTypes.func.isRequired,
};

export default Vesseltwentyfourhours;
